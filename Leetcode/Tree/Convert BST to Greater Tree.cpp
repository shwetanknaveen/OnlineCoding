...
public:
    void helper(TreeNode *root,int &sum)
    {
        ...
        sum += root->val;//now control has returned from right part hence add this node value to sum upto here so that it can be further given to left-smaller nodes
