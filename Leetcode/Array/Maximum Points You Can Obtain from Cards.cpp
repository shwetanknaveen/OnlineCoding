...
//On leetcode -> cardpoints-->A and k-->B
...
int Solution::solve(vector<int> &A, int B) {
    ...
    for(j=n-1;j>n-1-B;j--)//if all the numbers are taken from right side then in that case, index of leftmost taken number will be n-B
    {
